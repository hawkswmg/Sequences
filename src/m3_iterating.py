...
def run_test_count_negatives():
    ...
    # Test 6:
    expected = 1
    actual = count_negatives([56, -14, 32, 5])
    print()
    ...
    # Test 7:
    expected = 3
    actual = count_negatives([-4, -88, 4, -88])
    print()
...
def run_test_count_short_ones():
    ...
    # Test 8:
    expected = 2
    seq = [[6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6], [6, 6, 6, 6, 6, 6],
           [6], [6, 6]]
    actual = count_short_ones(seq)
    print()
    ...
    # Test 9:
    expected = 3
    seq = ['i', 'can', 'not', 'believe', 'it', 'is', 'not', 'butter']
    actual = count_short_ones(seq)
    print()
