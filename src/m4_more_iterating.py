...
def run_test_count_items_bigger_than():
    ...
    # Test 10:
    sequence = [195, -200, 720, 70, 201, 400]
    threshold = 200
    expected = 3
    actual = count_items_bigger_than(sequence, threshold)
    print()
...
def run_test_count_positive_sines():
    ...
    # Test 11:
    expected = 3
    actual = count_positive_sines([ 4, 7, 10, 13, 18, 24, 26])
    print()
...
def run_test_sum_first_n():
    ...
    # Test 8
    expected = 43
    actual = sum_first_n([55, -12, 30, -3], 2)
    print()
    print('Test 8 expected:', expected)
    print('       actual:  ', actual)
    ...
    # Test 9:
    expected = 70
    actual = sum_first_n([55, -12, 30, -3], 4)
    print()
    print('Test 9 expected:', expected)
    print('       actual:  ', actual)
